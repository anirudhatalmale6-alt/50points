    ...
    <div className="min-h-screen bg-brand-dark">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-32 lg:pb-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {raceDataTournaments.map((tournament, i) => (
                  ...
                  <div className="mb-4">
                    <div className="flex items-center justify-between text-xs mb-1.5">
                      <span className="text-zinc-400">
                        {t("tournamentsPage.race")} {tournament.racesCompleted} {t("tournamentsPage.of")} {tournament.totalRaces}
                      </span>
                    ...
                    <div className="w-full h-1.5 bg-white/5 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${(tournament.racesCompleted / tournament.totalRaces) * 100}%`,
                        }}
                      />
                    </div>
                  </div>
